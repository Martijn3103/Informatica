...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["password"]))){
        ...
        $password_err = "Uw wachtwoord moet minstens 6 tekens bevatten.";
    } else{
    ...
    if(empty(trim($_POST["confirm_password"]))){
        $confirm_password_err = "Uw wachtwoord moet nog bevestigd worden.";     
    } else{
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="section-title">
                                <h3 class="title">Registreren</h3>
                            </div>
                            <h4 class="sand-color">Vul de volgende gegevens in om een account aan te maken.</h4>
            ...
            <div class="form-group">
                <input type="submit" class="blauwe-btn" value="Registreren">
                <input type="reset" class="blauwe-btn" value="Reset">
            </div>
