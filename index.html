				...
				<div id="home-slick">
					...
					<div class="banner banner-1">
						...
						<div class="banner-caption text-center">
							...
							<a href ="producten-suikerpot-armbanden.html"><button class="primary-btn">*Shop nu*</button></a>
						</div>
					</div>
					<!-- /banner slick 1 -->
					...
					<div class="banner banner-1">
						...
						<div class="banner-caption">
							...
							<button class="primary-btn">Shop nu</button>
						</div>
					</div>
					<!-- /banner slick 2 -->
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="footer">
						...
						<form>
							...
							<button class="primary-btn">*Ja, ik wil graag de nieuwsbrief ontvangen.*</button>
						</form>
					</div>
				</div>
				<!-- /footer nieuwsbrief -->
